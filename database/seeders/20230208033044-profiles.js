...
module.exports = {
  async up (queryInterface, Sequelize) {
    ...
    try {
      const adminUser = await usersService.findUserByEmailOr404('andsan@academlo.com')
      const adminUser2 = await usersService.findUserByEmailOr404('sanro@academlo.com')
